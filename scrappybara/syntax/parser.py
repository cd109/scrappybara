...
class Parser(object):
    ...
    def __init__(self, nb_processes, batch_size):
    ...
    def __call__(self, token_lists):
        ...
        mats = run_multithreads(token_lists, self.__vectorize_sentence, self.__nb_processes)
        ...
        all_trees = run_multithreads(all_parses, _build_tree, self.__nb_processes)
